...
[ExecuteInEditMode]
public class SplineAnimateFixed: SplineComponent
{
    /// <summary>
    ...
    public enum LoopMode
    {
        ...
        Loop,
        /// <summary> Traverse the spline continuously without stopping. If <see cref="SplineAnimateFixed.Easing"/> is set to <see cref="SplineAnimateFixed.EasingMode.EaseIn"/> or
        /// <see cref="SplineAnimateFixedFixed.EasingMode.EaseInOut"/> then easing is only applied to the first loop of the animation. Otherwise, no easing is applied with this loop mode.
        /// </summary>
    ...
    internal static readonly string k_EmptyContainerError = "SplineAnimateFixedFixed does not have a valid SplineContainer set.";
    ...
    void EvaluatePositionAndRotation(out Vector3 position, out Quaternion rotation)
    {
        ...
        if (m_AlignmentMode != AlignmentMode.None)
        {
            ...
            if (math.all(valid))
                ...
                Debug.LogError("Trying to EvaluatePositionAndRotation with invalid parameters. Please check the SplineAnimateFixedFixed component.", this);
        }
        else
