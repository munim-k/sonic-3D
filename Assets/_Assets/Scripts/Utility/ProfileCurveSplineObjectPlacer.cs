...
public class ProfileCurveSplineObjectPlacer : MonoBehaviour {
    [Header("Placement Settings")]
    public SplineContainer profileSpline;
    ...
    void PlaceObjectAtNormalizedT(float t) {
        ...
        Vector3 profile_Position = SplineUtility.EvaluatePosition(profileSpline.Spline, profileOffset);
        ...
        //Rotation
        Vector3 profile_Tangent = SplineUtility.EvaluateTangent(profileSpline.Spline, profileOffset);
        ...
        Quaternion rotation = alignRotation
            ? targetRotation
            : Quaternion.identity;
        InstantiateObject(world_Position, rotation);
    }
    ...
    void OnDrawGizmosSelected() {
        ...
        for (int i = 0; i < placementCount; i++) {
            ...
            Gizmos.DrawSphere(world_Position, 1f);
        }
    }
#endif
